...
- **[Team Relay](https://github.com/entire-vc/evc-team-relay-mcp)** - Read, search, and write notes in your Obsidian vault through the self-hosted Team Relay API. Python, MIT, on PyPI.
